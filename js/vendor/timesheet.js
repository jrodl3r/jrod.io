(function() {
  ...
  Bubble.prototype.getStartOffset = function() {
    return this.start.getFullYear() === this.min ?
      (this.widthMonth/12) * (12 * (this.start.getFullYear() - this.min) + this.start.getMonth()) + 5 :
      (this.widthMonth/12) * (12 * (this.start.getFullYear() - this.min) + this.start.getMonth()) + 3;
  };
  ...
  Bubble.prototype.getWidth = function() {
    return this.getMonths() === 1 ?
      ((this.widthMonth/12) * this.getMonths()) + 4 :
      ((this.widthMonth/12) * this.getMonths()) - 5;
  };
...
(function() {
  ...
  Timesheet.prototype.parse = function(data) {
    for (var n = 0, m = data.length; n<m; n++) {
      ...
      var cat = data[n].length === 4 ? data[n][3] : data[n][2] || 'default';
