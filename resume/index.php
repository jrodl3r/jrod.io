...
<html class="no-js" lang="en-us">
  ...
  <body>
    <div id="page">
      <header>
        <div class="inner">
          <div class="left">John <span>Rodler</span></div>
          <div class="right">
            <ul class="menu">
